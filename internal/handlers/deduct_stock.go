...
// PUT /api/stock/articles/:articleId/deduct
func (h *DeductStockHandler) HandleByPath(c *fiber.Ctx) error {
	...
	stock, err := h.stockService.DeductStock(c.Context(), articleID, req.Quantity, req.Reason)
	if err != nil {
